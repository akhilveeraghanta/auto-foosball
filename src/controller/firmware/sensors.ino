...
ros::Publisher currLinearPosOneTopic("/uno/currLinearPositionOne",
                                     &currLinearPosOne);

// encoder angular position publisher rod 1
std_msgs::Int32 currAngularPosOne;
ros::Publisher currAngularPosOneTopic("/uno/currAngularPositionOne",
                                      &currAngularPosOne);

// encoder angular direction publisher rod 1
std_msgs::Int8 currAngularDirOne;
ros::Publisher currAngularDirOneTopic("/uno/currAngularDirectionOne",
                                      &currAngularDirOne);

// ultrasonic publisher linear position rod 2
std_msgs::Int32 currLinearPosTwo;
ros::Publisher currLinearPosTwoTopic("/uno/currLinearPositionTwo",
                                     &currLinearPosTwo);

// encoder angular position publisher rod 2
std_msgs::Int32 currAngularPosTwo;
ros::Publisher currAngularPosTwoTopic("/uno/currAngularPositionTwo",
                                      &currAngularPosTwo);

// encoder angular direction publisher rod 2
std_msgs::Int8 currAngularDirTwo;
ros::Publisher currAngularDirTwoTopic("/uno/currAngularDirectionTwo",
                                      &currAngularDirTwo);
...
int getCurrDirAngularOne() { return currentDir_1; }

int getCurrDirAngularTwo() { return currentDir_2; }
...
void loop() {
  ...
  // This segment should follow the angular position function calls as it shares
  // global variables with the getCurrPosAngular functions
